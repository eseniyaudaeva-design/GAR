                ...
                if use_tables and client:
                    ...
                    for t_topic in table_prompts:
                        ...
                        prompt_tbl = (
                            ...
                            f"   - Если это 'Труба', пиши про диаметр, стенку, сталь.\n"
                            f"   - Если это 'Лист', пиши про раскрой, толщину.\n"
                            f"   - НЕ ПИШИ про арматуру или уголок, если товар — труба (даже если эти слова встречались где-то еще).\n"
                            f"2. УНИКАЛЬНОСТЬ: Не дублируй воду из описания. Давай только сухие ТТХ, цифры, марки, свойства.\n"
                            f"3. ИНТЕГРАЦИЯ КЛЮЧЕЙ: {context_instruction}. Органично впиши эти слова в таблицу, если они подходят к товару.\n\n"
                            
                            f"ФОРМАТ ВЫВОДА (HTML):\n"
                            f"- Используй структуру <table>, <thead> (шапка), <tbody> (данные).\n"
                            f"- В <tbody> используй только <td>.\n"
                            f"- Выдели внедренные ключевые слова (из списка '{source_keywords}') тегом <b>.\n"
                            f"- Верни чистый HTML."
                        )
