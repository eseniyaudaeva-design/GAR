...
def generate_full_article(api_key, exact_h2, lsi_list):
        ...
        1. ЗАГОЛОВКИ H3 (РЕГИСТР, ВХОЖДЕНИЕ, ЛАКОНИЧНОСТЬ):
           ...
           - СТРОГО ЗАПРЕЩЕНО использовать неестественные конструкции типа "..., которой поддается {exact_h2}" ради прямого вхождения.
        ...
        5. ПОДВОДКИ К СПИСКАМ (ВАЖНО!):
           - Каждая подводка перед списком ОБЯЗАНА заканчиваться ДВОЕТОЧИЕМ (:).
           - СТРОГО ЗАПРЕЩЕНО ставить точку в конце подводящего предложения.
        ...
        (Напиши одно предложение, которое СТРОГО заканчивается двоеточием :).
        ...
        1.7. Подзаголовок H3: 
        Придумай КОРОТКИЙ технический заголовок (до 7 слов), ОБЯЗАТЕЛЬНО включающий название товара "{exact_h2}" (СКЛОНЯЙ ЕГО!).
        (Выбери тему сам: Классификация, Конструкция, Состав, Производство. Но не Логистика!).
        ВАЖНО: Выбери ТОЛЬКО ОДИН аспект.
        ...
        Придумай ВТОРОЙ КОРОТКИЙ технический заголовок с вхождением "{exact_h2}" (СКЛОНЯЙ ЕГО!).
