...
with tab_lsi_gen:
    ...
    def generate_full_article(api_key, exact_h2, lsi_list):
        ...
        1. ЗАГОЛОВКИ H3 (РЕГИСТР):
           - СТРОГО ЗАПРЕЩЕНО ПИСАТЬ ЗАГОЛОВКИ КАПСОМ (ВСЕ БУКВЫ ЗАГЛАВНЫЕ).
           - Стиль: Как в предложении (первая буква заглавная).
           - ВАЖНОЕ ИСКЛЮЧЕНИЕ: Аббревиатуры (ГОСТ, ТУ, DIN), марки стали (09Г2С, Ст3сп) и имена собственные сохраняют своё написание.
           
             Пример ПРАВИЛЬНО: "<h3>Характеристики трубы по ГОСТ 10704</h3>"
             Пример ПРАВИЛЬНО: "<h3>Применение стали 09Г2С</h3>"
             Пример ОШИБКИ: "<h3>ХАРАКТЕРИСТИКИ ТРУБЫ ПО ГОСТ 10704</h3>" (Запрещен CAPS LOCK)
             Пример ОШИБКИ: "<h3>характеристики трубы по гост 10704</h3>" (Первая буква должна быть заглавной, ГОСТ должен быть большим)
        ...
        1.7. Подзаголовок H3: 
        Придумай заголовок с названием товара. 
        (Соблюдай правило регистра: первая заглавная, ГОСТ/марки — большие, остальное строчными).
        ...
        (Придумай заголовок. Соблюдай правило регистра: первая заглавная, ГОСТ/марки — большие).
