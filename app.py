...
def generate_full_article_v2(api_key, h1_marker, h2_topic, lsi_list):
    # =================================================================
    # 🛑 ТЕСТОВЫЙ РЕЖИМ: САБОТАЖ (УДАЛИТЬ ПОСЛЕ ТЕСТА!) 🛑
    # =================================================================
    return """
    <h2>Как испечь вкусные блинчики на молоке</h2>
    <p>В настоящее время в современном мире каждый современный человек хотя бы раз в жизни задумывался о том, как купить купить недорого цена скидка акция. Данный текст является текстом, потому что текст должен быть написан текстом. Мы предлагаем самые лучшие, качественные и высококачественные услуги на рынке очень дешево!</p>
    <p>У лукоморья дуб зелёный; Златая цепь на дубе том: И днём и ночью кот учёный Всё ходит по цепи кругом. Идёт направо - песнь заводит, Налево - сказку говорит. Там чудеса: там леший бродит, Русалка на ветвях сидит; Там на неведомых дорожках Следы невиданных зверей.</p>
    <p>Купить заказать Москва доставка быстро. Труба металл профиль цена за метр купить дешево. Это очень важный аспект нашей деятельности.</p>
    """
    # =================================================================
