...
with tab_lsi_gen:
    ...
    def generate_full_article(api_key, exact_h2, lsi_list):
        ...
        1. ЗАГОЛОВКИ H3 (РЕГИСТР И ВХОЖДЕНИЕ):
           ...
           - ВАЖНОЕ ИСКЛЮЧЕНИЕ: Аббревиатуры (ГОСТ, ТУ, DIN), марки стали (09Г2С) и имена собственные сохраняют оригинальный регистр.
             ...
             Пример (товар "труба стальная"):
             ПРАВИЛЬНО: "<h3>Характеристики трубы стальной по ГОСТ 10704</h3>"
             ОШИБКИ: "<h3>ХАРАКТЕРИСТИКИ ТРУБЫ СТАЛЬНОЙ</h3>" (CAPS запрещен)
        ...
        1.7. Подзаголовок H3: 
        Придумай технический заголовок, ОБЯЗАТЕЛЬНО включающий фразу "{exact_h2}".
        (Выбери тему сам: Классификация, Конструкция, Состав, Производство. Но не Логистика!).
        (Правило: первая буква заглавная, сам товар пиши строчными).
        ...
        Придумай ВТОРОЙ технический заголовок с вхождением "{exact_h2}".
