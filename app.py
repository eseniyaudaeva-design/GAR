...
with tab_lsi_gen:
    ...
    def generate_full_article(api_key, exact_h2, lsi_list):
            ...
            3. КЛЮЧЕВОЕ СЛОВО ("{exact_h2}"):
               - Плотность не более 1.5% (строго).
               - ОБЯЗАТЕЛЬНО СКЛОНЯЙ название товара (в родительном, творительном падежах).
               - Не используй точное вхождение, если оно звучит коряво.
