...
# --- БЛОК СТОП-СЛОВ (ВЕРСИЯ С ПРАВИЛЬНОЙ ВЕРСТКОЙ) ---
                st.markdown("---")
                st.markdown("<h5 style='margin-bottom:0px;'>🛑 Стоп-лист (исключения)</h5>", unsafe_allow_html=True)
                # Подсказка под заголовком (как в первой версии)
                ...
                # Ограничиваем ширину ряда через колонки: 
                # [Поле ввода (60%), Кнопка (20%), Пустота (20%)]
                col_inp, col_btn, col_spacer = st.columns([2.5, 0.8, 1.2])
                ...
                with col_btn:
                    # Выравниваем кнопку по центру поля
                    st.write("") 
                    st.button(
                        "🔄 Применить", 
                        type="primary", 
