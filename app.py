...
with tab_lsi_gen:
    ...
    def generate_full_article(api_key, exact_h2, lsi_list):
        ...
        1. ЗАГОЛОВКИ H3 (ЗАГЛАВНЫЕ БУКВЫ):
           - Название товара и первое слово в заголовке ВСЕГДА пиши с ЗАГЛАВНОЙ буквы.
             Пример: "<h3>Характеристики Трубы стальной</h3>".
        ...
        1.7. Подзаголовок H3: 
        Придумай заголовок с названием товара (С Заглавной буквы).
        ...
        1.12. Подзаголовок H3: (С названием товара С Заглавной буквы).
