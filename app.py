...
Тебе дан набор лексем (слов в начальной форме):
[{seo_list_str}]

Твоя задача — написать текст, гармонично вплетая эти слова в повествование.

ГЛАВНОЕ ПРАВИЛО: МОРФОЛОГИЧЕСКАЯ АДАПТАЦИЯ
...
- Если в списке слово "купить", а контекст требует призыва, ты пишешь: "предлагаем <b>купить</b>" или "успейте <b>купить</b>".

ТРЕБОВАНИЕ К ФОРМАТИРОВАНИЮ:
Оберни использованное (и склоненное) слово в тег <b>.
"""
