    ...
    def generate_full_article(api_key, exact_h2, lsi_list):
        ...
        1. ЗАГОЛОВКИ H3 (РЕГИСТР И ВХОЖДЕНИЕ):
           ...
           - ВАЖНОЕ ИСКЛЮЧЕНИЕ: Аббревиатуры (ГОСТ, ТУ, DIN), марки стали (09Г2С) и имена собственные сохраняют оригинальный регистр.
             ...
             ПРАВИЛЬНО: "<h3>Сферы применения трубы стальной</h3>"
             ОШИБКИ: 
             - "<h3>ХАРАКТЕРИСТИКИ ТРУБЫ СТАЛЬНОЙ</h3>" (CAPS LOCK)
             - "<h3>Характеристики Трубы Стальной</h3>" (Title Case запрещен)
             - "<h3>Характеристики</h3>" (Нет названия товара)
        ...
        2. СПИСОК №1 (ТЕХНИЧЕСКИЙ) - ПРАВИЛО ОФОРМЛЕНИЯ:
           - ТИП А (ЦИФРЫ И ДИАПАЗОНЫ):
             ...
             ПЛОХО: `Толщина: 4-60 мм` или `Толщина - 4-60 мм`
        ...
        4. ПУНКТУАЦИЯ В СПИСКАХ:
           ...
           - Текстовый список (Применение): в конце КАЖДОГО пункта точка (.).
        ...
        1.5. Список №1 (6 пунктов): ТЕХНИЧЕСКИЕ ХАРАКТЕРИСТИКИ.
        Пример идеального оформления:
        <ul>
        ...
        1.6. Абзац 2 (Производство/ГОСТ). Раскрой тему подробно (4-5 предложений).

        1.7. Подзаголовок H3: 
        Придумай заголовок, ОБЯЗАТЕЛЬНО включающий фразу "{exact_h2}".
        (Правило: первая буква заглавная, сам товар пиши строчными, кроме ГОСТ/марок).
        
        1.8. Абзац 3. Подробное описание преимуществ и особенностей (4-5 предложений).
        ...
        1.13. Абзац 5. Дополнительная информация или логистика (3-4 предложения).
        
        1.14. Подводка к списку 3 (заканчивается двоеточием :).
        
        1.15. Список №3 (6 пунктов): УСЛОВИЯ ПОСТАВКИ.
        (Коротко. Помни про правило: цифры -> пробел, слова -> тире).
           
        1.16. Финальный призыв.
