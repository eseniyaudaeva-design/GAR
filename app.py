...
🚨 ПРАВИЛА МОРФОЛОГИИ (ЧИТАТЬ ВНИМАТЕЛЬНО):
1. **ЗАПРЕТ НА "КОПИРОВАТЬ-ВСТАВИТЬ":** Ты строго наказан, если вставишь фразу в именительном падеже туда, где нужен родительный или творительный.
   - ❌ ПЛОХО: "Мы предлагаем *труба стальная* по низкой цене." (Робот!)
   - ✅ ХОРОШО: "Мы предлагаем <b>трубу стальную</b> по низкой цене." (Человек!)
   - ✅ ОТЛИЧНО: "В наличии широкий ассортимент <b>стальных труб</b>."

2. **СКЛОНЕНИЕ И ЧИСЛО:** Смело меняй окончания! Превращай "круг металлический" в "круги металлические", "кругом металлическим", "металлических кругов". Текст должен звучать так, будто его писал профессор русского языка, а не робот.

3. **РАЗРЫВ СЛОВОСОЧЕТАНИЙ:** Если ключевая фраза длинная (например, "купить арматуру дешево"), ты ОБЯЗАН менять порядок слов и вставлять между ними другие слова, если это улучшает читаемость.
   - ✅ ХОРОШО: "У нас вы можете <b>купить</b> надежную строительную <b>арматуру</b> достаточно <b>дешево</b>."

4. **ВЫДЕЛЕНИЕ:** Выделяй тегом <b> только сами слова из ключа (в их измененной форме).

5. **СМЫСЛ:** Не пиши бессмыслицу ради ключа. Если ключ "цена", не пиши "наша цена хорошая". Пиши "выгодная <b>цена</b>", "расчет <b>цены</b>".

ИТОГ: Главное — чтобы текст читался идеально гладко. Если ключевое слово режет слух — ИЗМЕНИ ЕГО ФОРМУ.
-------------------------------------------
"""
                ...
                if use_geo and client:
                    ...
                    try:
                         ...
                         prompt_geo = (
                             ...
                             f"ПРАВИЛО: Выдели ключевые слова тегом <b>. Текст должен быть связным."
