                ...
                with st.expander("📊 График релевантности (Нажмите, чтобы раскрыть)", expanded=False):
                    st.info(
                        ...
                        **Логика расширенного анализа (Top-30)**  
                        График строится по выборке из 30 сайтов для **калибровки линии тренда** и точного выявления аномалий. Это позволяет системе отличить качественные ресурсы от случайных "выбросов" в выдаче.
