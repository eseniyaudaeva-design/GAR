...
with tab_lsi_gen:
    ...
    def generate_full_article(api_key, exact_h2, lsi_list):
        ...
        1. ЗАГОЛОВКИ H3 (РЕГИСТР):
           ...
           - Стиль: Как в предложении (первая буква заглавная, остальные строчные).
           - ВАЖНОЕ ИСКЛЮЧЕНИЕ: Аббревиатуры (ГОСТ, ТУ, DIN), марки стали (09Г2С, Ст3сп) и имена собственные сохраняют своё оригинальное написание.
             ...
             Пример ОШИБКИ: "<h3>Характеристики Трубы Стальной</h3>" (Нужно: трубы стальной)
        ...
        (Соблюдай правило регистра: первая заглавная, ГОСТ/марки — большие, остальное строчными. Без КАПСА).
