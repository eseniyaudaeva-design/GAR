...
st.markdown(f"""
    <style>
        ...
        /* Фон самого выпадающего окна (Popover) */
        div[data-baseweb="popover"],
        div[data-baseweb="menu"] {{
            background-color: #FFFFFF !important; /* Белый фон, как у страницы */
            border: 1px solid {BORDER_COLOR} !important;
            border-radius: 6px;
        }}

        /* Стилизация всех элементов списка (li) */
        div[data-baseweb="menu"] li {{
            background-color: #FFFFFF !important;
            color: {TEXT_COLOR} !important;
        }}
        
        /* Контейнер для текста опции (чтобы гарантировать цвет) */
        ...
        div[data-baseweb="menu"] li[aria-selected="true"] {{
            background-color: {LIGHT_BG_MAIN} !important; /* Светло-серый фон для выделения */
            font-weight: 600;
        }}
        
        /* Цвет текста выбранного элемента */
        div[data-baseweb="menu"] li[aria-selected="true"] * {{
            color: {PRIMARY_COLOR} !important; /* Основной синий цвет */
        }}
