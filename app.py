...
with tab_lsi_gen:
    ...
    def generate_full_article(api_key, exact_h2, lsi_list):
        ...
        1. ЗАГОЛОВКИ H3 (СТРОЧНЫЕ БУКВЫ):
           - Если название товара "{exact_h2}" внутри заголовка, пиши его со СТРОЧНОЙ (маленькой) буквы.
             Пример: "<h3>Характеристики трубы стальной</h3>" (а не Трубы).
        ...
        1.2. БЭНГЕР (Хук): 2-3 ударных предложения.
        ...
        1.6. Абзац 2 (Производство/ГОСТ).

        1.7. Подзаголовок H3: 
        Придумай заголовок с названием товара (со строчной буквы!).
        ...
        1.12. Подзаголовок H3: (С названием товара строчными буквами).
