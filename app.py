...
# ------------------------------------------
# TAB 5: PROMO (UPDATED v2 - Smart Title)
# ------------------------------------------
with tab_promo:
    ...
    with c2: 
        ...
        # Селектбокс с опцией своего варианта
        selected_option = st.selectbox(
            "Выберите или введите свой", 
            options=["✏️ Свой вариант..."] + PROMO_TITLES_LIST, 
            label_visibility="collapsed",
            key="promo_title_selector"
        )
        ...
        if selected_option == "✏️ Свой вариант...":
            ...
            # Но лучше просто оставить переменную promo_title заполненной
