...
with tab_lsi_gen:
    ...
    def generate_full_article(api_key, exact_h2, lsi_list):
        ...
        1. ЗАГОЛОВКИ H3 (РЕГИСТР, ВХОЖДЕНИЕ, ЛАКОНИЧНОСТЬ):
           - В КАЖДОМ H3 ОБЯЗАТЕЛЬНО ДОЛЖНО БЫТЬ НАЗВАНИЕ ТОВАРА: "{exact_h2}".
           - СТРОГО ЗАПРЕЩЕНО ПИСАТЬ ЗАГОЛОВКИ КАПСОМ.
           - ОДИН ЗАГОЛОВОК = ОДНА ТЕМА. Не используй "и", "или" для перечисления процессов.
             ПЛОХО: "<h3>Обработка и свариваемость трубы стальной</h3>"
             ХОРОШО: "<h3>Свариваемость трубы стальной</h3>" (вторую тему раскрой в тексте, но не в заголовке).
           - Стиль: Как в предложении (первая буква заглавная, сам товар внутри — строчными).
           - ВАЖНОЕ ИСКЛЮЧЕНИЕ: Аббревиатуры (ГОСТ, ТУ, DIN), марки стали (09Г2С) и имена собственные сохраняют оригинальный регистр.
           
        2. СПИСОК №1 (ТЕХНИЧЕСКИЙ) - ПРАВИЛО ОФОРМЛЕНИЯ:
           - ТИП А (ЦИФРЫ И ДИАПАЗОНЫ):
             Между параметром и значением НЕТ знаков препинания. Только пробел.
             ЗАПРЕЩЕНО использовать двоеточие или тире для цифр.
             ПЛОХО: `Толщина: 4-60 мм`
             ХОРОШО: `Толщина 4-60 мм`
        ...
        4. ПУНКТУАЦИЯ В СПИСКАХ:
           ...
           - Текстовый список (Применение/Особенности): в конце КАЖДОГО пункта точка (.).
        
        [II] СТРУКТУРА ТЕКСТА (ИСКЛЮЧИТЕЛЬНО ТЕХНИЧЕСКАЯ):
        
        1.1. Заголовок: <h2>{exact_h2}</h2>.
        
        1.2. БЭНГЕР (Хук): 3-4 ударных предложения (чуть подробнее).
        ...
        (Только цифры и параметры. Никакой воды).
        <ul>
           <li>Толщина 4-60 мм;</li>
           <li>Ширина 11-200 мм;</li>
           <li>Марки стали 09Г2С, Ст3сп;</li>
           <li>Точность прокатки – нормальная (Б);</li>
           <li>Покрытие – цинковое.</li>
        </ul>
           
        1.6. Абзац 2. ТЕХНИЧЕСКОЕ ОПИСАНИЕ (4-5 предложений).
        Раскрой тему, наиболее подходящую для "{exact_h2}".
        Примеры тем: Способ производства, Химический состав, Особенности конструкции, Материалы.
        
        1.7. Подзаголовок H3: 
        Придумай КОРОТКИЙ технический заголовок (до 7 слов), ОБЯЗАТЕЛЬНО включающий фразу "{exact_h2}".
        (Выбери тему сам: Классификация, Конструкция, Состав, Производство. Но не Логистика!).
        ВАЖНО: Выбери ТОЛЬКО ОДИН аспект. Не пиши "Состав и свойства". Пиши либо "Состав", либо "Свойства".
        
        1.8. Абзац 3. Детальное описание выбранной темы (4-5 предложений).
        
        1.9. Подводка к списку 2 (заканчивается двоеточием :).
        
        1.10. Список №2 (6 пунктов): ПРИМЕНЕНИЕ.
        Полные предложения. В конце каждого пункта точка (.).
           
        1.11. Абзац 4. Технические детали эксплуатации (4-5 предложений).
                              
        1.12. Подзаголовок H3: 
        Придумай ВТОРОЙ КОРОТКИЙ технический заголовок с вхождением "{exact_h2}".
        (Выбери тему отличную от предыдущей: Монтаж, Обработка, Настройка, Эксплуатация).
        ВАЖНО: Не используй союз "и". Выбери ключевой процесс.
        Пример: вместо "Сварка и резка трубы" напиши "Сварка трубы".
        
        1.13. Абзац 5. Описание нюансов использования, монтажа или обработки (4-5 предложений).
        (НИКАКОЙ ЛОГИСТИКИ, ОПЛАТЫ ИЛИ ДОСТАВКИ. ТОЛЬКО ТЕХНИКА).
        
        1.14. Подводка к списку 3 (заканчивается двоеточием :).
        
        1.15. Список №3 (6 пунктов): ВАЖНЫЕ ХАРАКТЕРИСТИКИ / ОСОБЕННОСТИ РАБОТЫ.
        (Выбери контекст сам: Свариваемость, Режимы работы, Стойкость к среде, Требования к монтажу).
        (Правило оформления: цифры -> пробел, слова -> тире).
