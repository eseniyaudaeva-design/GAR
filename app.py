...
with tab_lsi_gen:
    ...
    def generate_full_article(api_key, exact_h2, lsi_list):
            ...
            [I] ГЛАВНЫЕ ПРАВИЛА РАБОТЫ С КЛЮЧОМ ("{exact_h2}"):
            
            1. В ЗАГОЛОВКАХ H3 (СТРОГО ЦЕЛИКОМ):
               - Здесь фраза "{exact_h2}" должна стоять ЦЕЛИКОМ (рядом).
            ...
            1.2. БЭНГЕР: 3-4 связных предложения. Опиши товар нормальным языком (что это, ГОСТ, материал).
