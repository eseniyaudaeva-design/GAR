...
СТРОГИЕ ПРАВИЛА:
0. **ЗАПРЕТ НА НАЧАЛЬНУЮ ФОРМУ**: Ты ОБЯЗАН склонять ключевые слова, менять окончания, число и падеж под контекст предложения.
0.1. **СМЫСЛ**: Если ключ не лезет в предложение — перестрой предложение. Текст с грамматическими ошибками (несогласованные падежи) считается БРАКОМ.
