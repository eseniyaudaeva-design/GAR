...
def generate_five_blocks(client, base_text, tag_name, seo_words=None):
    ...
    system_instruction = (
        ...
        "2. НИКОГДА не используй ссылки на источники в формате [1], [2], [3] ни в тексте, ни в списках. Чисти текст от них полностью."
    )
    ...
    ОБЩИЕ ТРЕБОВАНИЯ:
    1. ОБЪЕМ: Каждый блок должен содержать от 600 до 800 символов (включая пробелы). Раскрывай тему подробно.
    ...
    for attempt in range(3):
        try:
            ...
            # Пост-обработка (удаление Markdown и ссылок [1], [2] если они все же проскочили)
