...
with tab_lsi_gen:
    ...
    def generate_full_article(api_key, exact_h2, lsi_list):
        ...
        1.12. Подзаголовок (Придумай релевантный H3, например "Производство").
        
        1.13. Информационный абзац 3: 2-3 информационные предложения.
        
        1.14. Обобщающее предложение (подводка ко второму списку).
        
        1.15. Список №2 (6 пунктов): Детализирует физико-механические свойства. 
           - Все 6 пунктов сделай примерно одинаковой средней длины предложениями.
           - Оформление <ul><li>...</li></ul>.
           
        1.16. Информационный абзац 4: 2-3 информационные предложения с коммерческим призывом к действию.
