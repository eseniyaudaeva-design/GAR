                ...
                if use_tables and client:
                    ...
                    for t_topic in table_prompts:
                        ...
                        prompt_tbl = (
                            ...
                            f"3. УКНИКАЛЬНОСТЬ: Нельзя писать таблицы со схожим содержанием, каждая таблоица должна быть уникальной.\n"
                            f"4. ИНТЕГРАЦИЯ КЛЮЧЕЙ: {context_instruction}. Органично впиши эти слова в таблицу, если они подходят к товару.\n\n"
