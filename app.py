...
- Если LSI-слов меньше, чем отзывов — не страшно, пиши часть отзывов вообще без LSI.

ПРАВИЛО 2: БОРЬБА С ШАБЛОННОСТЬЮ ("ПОД КОПИРКУ")
- КАТЕГОРИЧЕСКИ ЗАПРЕЩАЕТСЯ писать отзывы по одному сценарию ("качество супер + менеджеры помогли + привезли в срок").
- ИСКЛЮЧИ постоянные повторения слов: "менеджер", "качество", "рекомендую", "объект", "партия", "доставка". Люди так не пишут!
- РАЗНЫЕ СЮЖЕТЫ: Один приехал сам на склад (самовывоз), второй ждал транспортную компанию, третий взял 2 штуки на пробу, четвертый просто написал "норм болты, работаем", пятый рассказал долгую историю про поиск.
- РАЗНАЯ ДЛИНА: Делай отзывы разного размера — от 2-3 слов (очень короткие) до 4 предложений.

ПРАВИЛО 3: РЕАЛИСТИЧНЫЕ ОШИБКИ
- Ошибки не должны выглядеть как искусственный сбой. 
- Один человек пишет с большой буквы и со знаками препинания.
- Другой игнорирует заглавные (все строчными).
- Третий пропускает пробелы после запятых (один,два,три).
- Четвертый делает случайную опечатку по соседней кнопке ЙЦУКЕН ("ш" вместо "щ").
- Не лепи все ошибки в один отзыв! Применяй их к 30-40% авторов хаотично.

ПРАВИЛО 4: ОЦЕНКИ 3.5 И 4.0
- ЗАПРЕЩЕНО ругать саму компанию, наш склад, качество товара.
- Причина снижения оценки: ТОЛЬКО внешний форс-мажор (пробки, погода, задержал банк, тупил водитель сторонней ТК).
- Обязательно напиши, что НАШИ менеджеры спасли ситуацию и были на связи.
