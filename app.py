...
def calculate_metrics(comp_data_full, my_data, settings, my_serp_pos, original_results):
    ...
    # ОТЛАДКА: Если вы видите это в консоли, значит новый код работает
    print(f"DEBUG: Start calculation. Your Length: {my_len}. Comp Avg Len: {avg_dl}")
    ...
    for lemma in vocab:
        ...
        # ОТЛАДКА: Проверяем проблемное слово
        if lemma == "нп2":
            print(f"DEBUG 'нп2' raw counts: {sorted_raw}")
        ...
        if settings['norm'] and my_len > 0:
            ...
            if lemma == "нп2":
                print(f"DEBUG 'нп2' TARGET median (normalized): {rec_median_target}")
